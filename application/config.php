...
return [
    ...
    'template'               => [
        ...
        'tpl_replace_string' =>[
            ...
            '__STATIC__' => $_SERVER['REQUEST_SCHEME']."://".$_SERVER['HTTP_HOST'].rtrim(dirname($_SERVER['SCRIPT_NAME'])).'/statics',
        ],
    ],
    ...
    'MONEY'=>[//检索-金额检索key所对赢的金额
        0   =>  array('min'=>0,'max'=>0),
        1   =>  array('min'=>0,'max'=>1),
        2   =>  array('min'=>1,'max'=>10),
        3   =>  array('min'=>10,'max'=>20),
        4   =>  array('min'=>20,'max'=>50),
        5   =>  array('min'=>50,'max'=>100),
        6   =>  array('min'=>100,'max'=>999999999),
    ],
    'RETURNLOG'=>[//返回码
        'ERROR'   =>  array(
            0=>array('code'=>400,'msg'=>'错误'),
            1=>array('code'=>401,'msg'=>'参数错误'),
            2=>array('code'=>500,'msg'=>'内部错误'),
    ...
    'IMAGE'=>[//图片地址前缀&&默认头像
        'AVATAR'=>"https://".$_SERVER['SERVER_NAME'].'/uploads/defultavatar.jpg',
